...
*If your data is at DZ level (and does not use standardised rates), use the syntax 'DZ raw data - crude rate and percentage' instead.
...
*Anna Mackinnon, 19th August 2015.
...
*Date: 03/02/16.
 * Jaime Villacampa 18-1-17 Deleting calls to macro from syntax file.
